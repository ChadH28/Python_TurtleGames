...
mscreen.bgcolor('Blue')
mscreen.title('Hockey')
...
# functions
mscreen.listen()
mscreen.onkeypress(up1 , 'Up')   #up for playerRight
mscreen.onkeypress(up2 , 'w')   #up for playerLeft
mscreen.onkeypress(down1 , 'Down') #down for playerRight
mscreen.onkeypress(down2 , 's') #down for playerLeft
